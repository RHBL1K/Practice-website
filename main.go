...
// Константы для SMTP и MongoDB
const (
	SMTPServer      = "smtp.gmail.com"
	SMTPPort        = "587"
	SenderEmail     = "your-email@gmail.com"       // Укажи почту отправителя
	SenderPassword  = "your-app-password"          // Укажи пароль приложения Google
	ReceiverEmail   = "receiver-email@gmail.com"   // Укажи почту получателя
	MongoDBURI      = "mongodb+srv://Aldiyar:Nursultan2005@cluster0.8jzkf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&tls=true"
	DatabaseName    = "DBTOO"
	CollectionName  = "messages"
)
...
func main() {
	...
	port := os.Getenv("PORT")
	if port == "" {
		port = "10000" // Render использует 10000 по умолчанию
	}
